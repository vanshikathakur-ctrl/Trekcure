...
class _HomeDashboardScreenState extends State<HomeDashboardScreen> {
  ...
  // ============================================================
  // BUILD METHOD (EXPANDED UI TO OCCUPY VIEWPORT)
  // ============================================================
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            const Icon(Icons.menu, color: AppColors.textDark, size: 28),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ======================================================
              // 2. DYNAMIC WEATHER & DYNAMIC CROWD ROW (EQUAL HEIGHTS)
              // ======================================================
              IntrinsicHeight(
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    // Dynamic Weather Card (Enlarged Elements)
                    Expanded(
                      child: AppCard(
                        child: Padding(
                    ...
                    // Dynamic Crowd Card (Enlarged & Stretched)
                    Expanded(
                      child: AppCard(
                        child: Padding(
                          padding: const EdgeInsets.all(8),
